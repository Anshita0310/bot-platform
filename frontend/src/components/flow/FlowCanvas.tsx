...
const FlowCanvas = () => {
  ...
  const handleLoadExample = useCallback(() => {
    ...
    const exampleNodes: Node[] = [
      { id: "node_1", type: "custom", position: { x: 250, y: 0 }, data: { type: "message", label: "Welcome", message: "Welcome to PizzaBot! 🍕 I can help you order a pizza." } as Record<string, unknown> },
      { id: "node_2", type: "custom", position: { x: 250, y: 150 }, data: { type: "entity", label: "Get Pizza Size", entityName: "pizzaSize", entityType: "string", prompt: "What size pizza would you like? (Small, Medium, Large)" } as Record<string, unknown> },
      { id: "node_3", type: "custom", position: { x: 250, y: 320 }, data: { type: "entity", label: "Get Toppings", entityName: "toppings", entityType: "string", prompt: "What toppings would you like?" } as Record<string, unknown> },
      { id: "node_4", type: "custom", position: { x: 250, y: 490 }, data: { type: "confirmation", label: "Confirm Order", question: "You want a {{pizzaSize}} pizza with {{toppings}}. Place order?", yesLabel: "Yes", noLabel: "No" } as Record<string, unknown> },
      { id: "node_5", type: "custom", position: { x: 50, y: 680 }, data: { type: "tool", label: "Place Order", toolName: "placeOrder", description: "Calls the order API to place the pizza order" } as Record<string, unknown> },
      { id: "node_6", type: "custom", position: { x: 450, y: 680 }, data: { type: "message", label: "Cancelled", message: "No problem! Let me know if you change your mind." } as Record<string, unknown> },
    ];
    const exampleEdges: Edge[] = [
      ...
      { id: "e4-5", source: "node_4", sourceHandle: "yes", target: "node_5", type: "condition", animated: true, style: { stroke: 'hsl(220, 15%, 40%)' }, data: { label: "Yes" } },
      { id: "e4-6", source: "node_4", sourceHandle: "no", target: "node_6", type: "condition", animated: true, style: { stroke: 'hsl(220, 15%, 40%)' }, data: { label: "No" } },
    ];
  ...
  return (
    <div className="flex flex-col h-screen w-full">
      <FlowToolbar onExportJSON={handleExportJSON} onClear={handleClear} onTestFlow={() => setShowTestPanel(true)} onLoadExample={handleLoadExample} />
